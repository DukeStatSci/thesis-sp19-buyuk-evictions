...
```{r transres1, fig.cap="Sensitivity Analysis: Considering Different Transaction Windows",out.width = "600px",echo=FALSE,fig.align="center"}
library(knitr)
...
```{r yearres1, fig.cap="Fixed Effect: Year",out.width = "600px",echo=FALSE,fig.align="center"}
...
```{r transres2, fig.cap="Sensitivity Analysis: Considering Different Transaction Windows",out.width = "600px",echo=FALSE,fig.align="center"}
include_graphics(path = "Figures/FINALoutintransrobust.jpeg")
```

```{r yearres2, fig.cap="Fixed Effect: Year",out.width = "600px",echo=FALSE,fig.align="center"}
...
```{r robusres3, fig.cap="Sensitivity Analysis: Considering Different Cut-offs for Large Investor",out.width = "600px",echo=FALSE,fig.align="center"}
include_graphics(path = "Figures/FINALcutoffsrobustness.jpeg")
```

```{r transres3, fig.cap="Sensitivity Analysis: Considering Different Transaction Windows",out.width = "600px",echo=FALSE,fig.align="center"}
