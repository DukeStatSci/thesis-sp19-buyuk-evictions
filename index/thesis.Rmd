...
```{r evicrates, fig.cap="Eviction Rates Across Different Property Sizes in Durham Between 2004 and 2018"}
...
```{r dems, fig.cap="The Impact of Eviction Rates on Different Demographics"}
...
```{r corpchanges, fig.cap="Proportion of Properties Under Corporate Ownership Across Different Property Sizes"}
...
```{r statechanges, fig.cap="Proportion of Corporate Ownership Based Out-of-State  "}
...
```{r transres1, fig.cap="Sensitivity Analysis: Considering Different Transaction Windows"}
library(knitr)
...
```{r yearres1, fig.cap="Fixed Effect: Year"}
...
```{r transres2, fig.cap="Sensitivity Analysis: Considering Different Transaction Windows"}
include_graphics(path = "Figures/FINALoutinstransrobust.jpeg")
```

```{r yearres2, fig.cap="Fixed Effect: Year"}
...
```{r robusres3, fig.cap="Sensitivity Analysis: Considering Different Cut-offs for Large Investor"}
include_graphics(path = "Figures/FINALcutoffsrobustness.jpeg")
```

```{r transres3, fig.cap="Sensitivity Analysis: Considering Different Transaction Windows"}
...
[^6]: The distanced investor is a case where it is not completely clear who the landlord is, and tenants perceive some difficulty in reaching their landlord to discuss their personal situation.
